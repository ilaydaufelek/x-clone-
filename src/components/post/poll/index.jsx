		...
		<div className="mt-3 grid gap-1">
			{!poll.voted && poll.answers.map((answer) => (
				<button
					...
					className="h-8 border border-[color:var(--color-primary)] rounded-full text-[color:var(--color-primary)] font-bold hover:bg-[color:var(--color-third)] transition-colors"
					key={answer.id}
				>
					{answer.text}
				</button>
