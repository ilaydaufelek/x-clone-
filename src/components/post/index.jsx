...
import Poll from "./poll";
     ...
     export default function Post({post,setPost,topicList}){
        ...
        <img className="w-10 h-10 rounded-full object-cover " src={post?.account?.avatar} alt="" />
        <div className="flex-1" >
            <header className="leading-5 flex items-center gap-1 mb-0.5 justify-between " >
                    ...
                    <div className="text-[color:var(--color-baseSecondary)]  text-[0.938rem] gap-1 flex items-center  " >
                      ...
                      <div>3s</div> 
                       ...
                       <Popover className='relative' >
                                   <PopoverButton
                                   className="h-[2.172rem] w-[2.172rem] flex items-center justify-center hover:bg-[#1d9bf01a] rounded-full outline-none " >
                                    <svg 
                                    ...
                                    <PopoverPanel  className='  bg-[color:var(--background-primary)]  w-[21.75rem] grid  overflow-hidden shadow-box absolute  top-2 right-0   rounded-xl z-[1] ' >
                                     <button 
                                   onClick={()=>{
                                    setPost(()=>{
                                        const postdelete=topicList.filter((c)=>c.id !== post.id)
                                        return [...postdelete]
                                    })
                                   }}
                                     className="h-10  w-full font-bold flex px-4 py-2   items-center gap-1.5 hover:bg-[color:var(--background-fourth)] " >
                                     <div>
               ...
               {post.type ==='poll' && <Poll poll={post.poll} /> }
                ...
                <div className="flex -ml-1.5 mt-1.5" >
                    <div className="flex-1 group flex items-center  " >
                        ...
                        <div className="text-[0.813rem] transition-colors text-[color:var(--color-baseSecondary)] group-hover:text-[#1D9BF0] flex items-center " >{numberFormat(post.stats.comments)}</div>
                    ...
                    <div className="flex-1 group flex items-center  " >
                        ...
                        <div className="text-[0.813rem] transition-colors text-[color:var(--color-baseSecondary)] group-hover:text-[#07BC7F] flex items-center " >{numberFormat(post.stats.repost)}</div>
                    ...
                    <div className="flex-1 group flex items-center  " >
                        ...
                        <div className="text-[0.813rem] transition-colors text-[color:var(--color-baseSecondary)] group-hover:text-[#f91880] flex items-center " >{numberFormat(post.stats.like)}</div>
                    ...
                    <div className="flex-1 group flex items-center  " >
                       ...
                       d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"/>
                        ...
                        <div className="text-[0.813rem] transition-colors text-[color:var(--color-baseSecondary)] group-hover:text-[#1D9BF0] flex items-center " >{numberFormat(post.stats.view)}</div>
